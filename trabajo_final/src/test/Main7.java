...
public class Main7 implements Runnable{ 
	...
	public Main7(int inicio, int fin, int idHilo) {
		super();
		this.inicio = inicio;
		this.fin = fin;
		this.idHilo = idHilo;
	...
	public static void main(String[] args) {
		...
		array2 = Array.ArrayDescendente(1000000);		//para ambos arrays
		...
		for (int i = 0; i < numeroNucleos; i++) { //en este for se reparten las partes en las que cada hilo trabajará
			...
			hilos[i] = new Thread(new Main7(inicio, fin, i));	
		}
		...
		for (int i = 0; i < numeroNucleos; i++) { //en este for se reparten las partes en las que cada hilo trabajará
			...
			hilos2[i] = new Thread(new Main7(inicio, fin, i));	
		}
