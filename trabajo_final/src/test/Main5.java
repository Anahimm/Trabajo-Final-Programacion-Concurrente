...
public class Main5 implements Runnable{ 
	...
	public Main5(int inicio, int fin, int idHilo) {
		super();
		this.inicio = inicio;
		this.fin = fin;
		this.idHilo = idHilo;
	...
	public static void main(String[] args) {
		...
		array1 = Array.ArrayAleatorio(100000, 1, 20000); //se declaran la longuitud y rango 
		array2 = Array.ArrayDescendente(100000);		//para ambos arrays
		...
		for (int i = 0; i < numeroNucleos; i++) { //en este for se reparten las partes en las que cada hilo trabajará
			...
			hilos[i] = new Thread(new Main5(inicio, fin, i));	
		}
		...
		for (int i = 0; i < numeroNucleos; i++) { //en este for se reparten las partes en las que cada hilo trabajará
			...
			hilos2[i] = new Thread(new Main5(inicio, fin, i));	
		}
